...
export default function VoucherDetails() {
    ...
    return (
        <Paper sx={{ p: 4, maxWidth: 700 }}>
            ...
            <Divider sx={{ my: 2 }} />
            <Typography variant="subtitle1" fontWeight={600} mb={1}>Employee Information</Typography>
            <Grid container spacing={2}>
                <Grid item xs={6}><Field label="Employee ID" value={voucher.employee_id} /></Grid>
                <Grid item xs={12}>
            ...
            <Box mt={3}>
                <Button variant="outlined" onClick={() => navigate('/employee/my-vouchers')}>Back to My Vouchers</Button>
            </Box>
        </Paper>
    );
}